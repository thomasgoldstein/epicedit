    ...
    internal sealed class Game : IDisposable
    {
        ...
        private static void AddObjectPaletteCodeChunk(SaveBuffer saveBuffer, Region region)
        {
            ...
            byte[] hack2 = new byte[]
            {
                ...
                val1, 0xBD, 0x80, 0x20, 0x84, 0x5E, 0xD0, 0x1A,
                0xD4, 0x00, 0x20, 0xD1, 0x5E, 0xBD, 0x02, 0x00,
                ...
                0x84, 0x5E, 0xD0, 0x24, 0xD4, 0x00, 0x20, 0xD1,
                ...
                0xFF, 0x00, 0x0A, 0xAA, 0x68, 0xDF, 0xB5, 0x5E,
                0xC8, 0xF0, 0x11, 0xDF, 0xC3, 0x5E, 0xC8, 0xF0,
                0x0B, 0xC0
            };
