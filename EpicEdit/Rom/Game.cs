    ...
    internal sealed class Game : IDisposable
    {
        ...
        private static void AddObjectPaletteCodeChunk(SaveBuffer saveBuffer, Region region)
        {
            ...
            byte[] hack2 = new byte[]
            {
                ...
                0x02, 0x68, 0x85, 0x00, 0x5C, val1, 0xBD, 0x80,
                0xB9, 0x02, 0x00, 0x45, 0x1A, 0x95, 0x06, 0xB9,
                0x00, 0x00, 0x45, 0x1A, 0x95, 0x02, 0x5C, val1,
